...
const colorClasses: Record<ProjectSkill['color'], string> = {
  ...
  rose:
    'bg-rose-400/10 text-rose-800 border-rose-400/25 dark:bg-rose-400/15 dark:text-rose-300/55 dark:border-rose-400/20',
  sky:
    'bg-sky-400/10 text-sky-800 border-sky-400/25 dark:bg-sky-400/15 dark:text-sky-300/55 dark:border-sky-400/20',
  slate:
